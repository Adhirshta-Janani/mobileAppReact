  ...
  return (
    <View style={styles.itemContainer}>
      <TouchableOpacity onPress={toggleExpand} style={styles.itemTouchable}>
        ...
        >
          {item.id == 1 || item.id == 7 || item.id == 10 ? (
            <Text style={styles.hyperLinkrow}> {item.name} </Text>
          ) : (
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data.length) {
          ...
          setData(
            (DATA[0].value = responseData["DAWeeklyDeliveryMetrics"][0]["overallTier"])
          );
          setData(
            (DATA[0].performance = responseData["DAWeeklyDeliveryMetrics"][0]["overallTiercompare"])
          );
          ...
          setData(
            (DATA[1].performance = responseData["Mentor"][0]["MentorFICOScoreCompare"])
          );
          setData(
            (DATA[2].value =
          ...
          setData(
            (DATA[2].performance =
              responseData["DAWeeklyDeliveryMetrics"][0]["SeatbeltOffCompare"])
          );
          ...
          setData(
            (DATA[3].performance =
              responseData["DAWeeklyDeliveryMetrics"][0]["SpeedingEventcompare"])
          );
          setData(
            (DATA[4].value =
          ...
          setData(
            (DATA[7].value =
              responseData["CustomerFeedback"][0][
                "cdfScore"
              ])
          );
          setData(
